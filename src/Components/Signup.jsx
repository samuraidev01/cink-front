...
export default function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("http://127.0.0.1:8000/api/register", {name,email,password,c_password})
  ...
  return (
    <div className="mx-auto px-4 w-[90vw] flex items-center justify-center h-fit mt-20">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {(errors && errors.name) && <p className="text-red-600">{errors.name[0]}</p>}
        <label className="input input-bordered flex items-center gap-2">
        ...
        <label className="input input-bordered flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path fillRule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clipRule="evenodd" /></svg>
          <input onChange={(e) => setCPassword(e.target.value)} type="password" className="grow" placeholder="Confirm Password" />
        </label>
        {(errors && errors.c_password) && <p className="text-red-600">{errors.c_password[0]}</p>}
